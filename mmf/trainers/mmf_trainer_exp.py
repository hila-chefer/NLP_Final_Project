...
from mmf.trainers.core.evaluation_loop import TrainerEvaluationLoopMixinExp, TrainerEvaluationLoopMixinHeadPruning, \
    TrainerEvaluationLoopMixinLayerPruning
...
@registry.register_trainer("mmf_exp")
class MMFTrainer(
    TrainerCallbackHookMixin,
    TrainerTrainingLoopMixin,
    TrainerDeviceMixin,
    TrainerEvaluationLoopMixinExp,
        ...
        for dataset in dataset_type:
            if self.config.evaluation.predict:
                ...
                self.evaluation_loop(
                    getattr(self, f"{dataset}_loader"), use_tqdm=True, config=self.config.prune
                )


@registry.register_trainer("mmf_head_prun")
class MMFTrainer(
    TrainerCallbackHookMixin,
    TrainerTrainingLoopMixin,
    TrainerDeviceMixin,
    TrainerEvaluationLoopMixinHeadPruning,
    TrainerReportingMixin,
    TrainerProfilingMixin,
    BaseTrainer,
):
...
@registry.register_trainer("mmf_layer_prun")
class MMFTrainer(
    TrainerCallbackHookMixin,
    TrainerTrainingLoopMixin,
    TrainerDeviceMixin,
